...
class DeleteReservation extends React.Component {
  ...
  handleSubmit = (event) => {
    alert(
      `${this.state.firstName} ${this.state.lastName} Deleted Information Succesfully..!!!`
    );
    ...
    return (
      <div>
        <form onSubmit={this.handleSubmit}>
          ...
          <lable>Checkin_date:</lable>
          <td>
            <input
              type="text"
              value={this.state.checkin_date}
              onChange={this.checkin_date}
              placeholder="Check in Date"
            />
            <br />
            <br />
          </td>
          <lable>Checkout_date:</lable>
          <td>
            <input
              type="text"
              value={this.state.checkout_date}
              onChange={this.checkout_date}
