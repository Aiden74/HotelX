...
class Reservation extends Component{ 
  ...
  lasthandler = (event) => {
    ...
    roomhandler = (event) =>{
      ...
      handleSubmit = (event) => {
        alert(`${this.state.firstName} ${this.state.lastName} Room Booked Succesfully..!!!`)
        ...
        return (
          <div>
            <form onSubmit={this.handleSubmit}>
              ...
              <lable>Budget:</lable><td><input type="text" value={this.state.budget} onChange={this.budgethandler} placeholder="Budget.."/><br /><br /></td>
              ...
              <lable>Gender: </lable><td><select onChange={this.genderhandler} defaultValue="Select Gender"><br />
              
                <option defaultValue>Select Gender</option><br />
                <option value="male">Male</option><br />
                <option value="Female">Female</option><br />
                </select></td><br />
              <lable>Check-in-Date:</lable><td><input type="text" value={this.state.checkin_date} onChange ={this.checkindatehandler} placeholder="Check-in-Date" /><br /><br /></td>
              <lable>Check-out-Date:</lable><td><input type="text" value={this.state.checkout_date} onChange ={this.checkouthandler} placeholder="Check-out-Date" /></td><br /><br />
